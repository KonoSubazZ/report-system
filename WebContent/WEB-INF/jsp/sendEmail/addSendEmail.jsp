...
<div class="panel admin-panel">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>添加送检机构</strong></div>
	    ...
	    <tr>
	    	<td>
		      <div class="form-group">
		        ...
		        <div class="field">
		          <input type="text" class="input w50" value="" name="customer" id="customer"  data-validate="required:请输入customer"/>
		          <div class="tips"></div>
	     ...
	     <tr>
	    	<td>
		      <div class="form-group">
		        ...
		        <div class="field">
					<textarea cols="10" rows="10" type="text" class="input w50" value="" name="emailaddress" id="emailaddress" data-validate="required:请输入emailaddress"></textarea>
		          <div class="tips"></div>
		        </div>
		      </div>
		     </td>
	    	<td>
	    	  <div class="form-group" style="margin-left: 0px;">
		        ...
		        <div class="field">
					<textarea cols="10" rows="10" type="text" class="input w50" value="" name="CCemail" id="CCemail"></textarea>
		          <div class="tips"></div>
		        </div>
		      </div>
		     </td>
		...
		<tr>
			<td>
				<div class="form-group">
					...
					<div class="field">
						<textarea cols="10" rows="10" type="text" value="" style="width:288px;height:222px;" name="content" id="content"></textarea>
						<div class="tips"></div>
					</div>
				</div>
			</td>
      				...
      				$("#sendEmailForm").validate({
	    					...
	    					submitHandler:function(){
	    						$.ajax({   
	    							cache: false,
	    							type: "POST",   
	    							url:"${pageContext.request.contextPath}/sendEmail/saveSendEmail", //把表单数据发送到ajax.jsp
