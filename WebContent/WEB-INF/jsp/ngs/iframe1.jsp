		...
		<div id="tabs">
		  <ul style="min-width: 1720px;">
		    ...
		    <%--<c:if test="${ user.role_id != 8 }">
			  ...
			  <li><a href="#tabs-8" onclick="urlRun7();" style="cursor: pointer;">报告审核及下载</a></li>
		    <%--<li style="margin-left: 300px"><a href="#tabs-9" onclick="fun_back();" id="button_back" >返回报告管理</a></li>--%>
		  </ul>
		  <form id="form_back" method="post" action="${pageContext.request.contextPath}/NgsAvailableDataVw/lifeList2" >
	        ...
	        <script type="text/javascript">
	        	...
	        	function urlRun(){
	   			  var objFrm = document.getElementById('addLife');
	        	...
	        	function urlRun3(){
	   		      ...
	   		      objFrm.src = "${pageContext.request.contextPath}/filter/filterIndex?report_id=${currentNgsAvailable.report_id}&platform=${currentNgsAvailable.platform}&subbarcode=${currentNgsAvailable.subbarcode}&analysis_date=${currentNgsAvailable.analysis_date}&product_name=${currentNgsAvailable.product_name}&flag=1";
	   		      objFrm.style.display = "block";
	    		}
	        	function urlRun4(){
				...
				function urlRun7(){
					var objFrm = document.getElementById('produceAndReviewReport');
					objFrm.src = "${pageContext.request.contextPath}/geneMarkerVw/produceReport?report_id=${currentNgsAvailable.report_id}&platform=${currentNgsAvailable.platform}&subbarcode=${currentNgsAvailable.subbarcode}&analysis_date=${currentNgsAvailable.analysis_date}&product_name=${currentNgsAvailable.product_name}&life=${currentNgsAvailable.life}&illumina=${currentNgsAvailable.illumina}&subbarcode_show=${currentNgsAvailable.subbarcode_show}&product_name_show=${currentNgsAvailable.product_name_show}&analysis_date_show=${currentNgsAvailable.analysis_date_show}&status=${currentNgsAvailable.status}&pageNo=${currentNgsAvailable.pageNo}&flag=1";
					objFrm.style.display = "block";
				}
	        	function urlRun_4(data){
	        		window.location.href="${pageContext.request.contextPath}/life/lifeMain1?report_id="+data+"&platform=${currentNgsAvailable.platform}&subbarcode=${currentNgsAvailable.subbarcode}&analysis_date=${currentNgsAvailable.analysis_date}&product_name=${currentNgsAvailable.product_name}&product_id=${product.product_id}&life=${currentNgsAvailable.life}&illumina=${currentNgsAvailable.illumina}&subbarcode_show=${currentNgsAvailable.subbarcode_show}&product_name_show=${currentNgsAvailable.product_name_show}&analysis_date_show=${currentNgsAvailable.analysis_date_show}&pageNo=${currentNgsAvailable.pageNo}&falg=4";
	    		}
		  ...
		  <div id="tabs-1" style="height:782px;">
		    <iframe id="addLife" scrolling="no" width="100%" height="100%" frameborder="0"></iframe>
		  </div>
		  ...
		  <div id="tabs-4" style="height:782px;">
		  	<iframe id="filter" scrolling="auto" src="${pageContext.request.contextPath}/filter/filterIndex?report_id=${currentNgsAvailable.report_id}&platform=${currentNgsAvailable.platform}&subbarcode=${currentNgsAvailable.subbarcode}&analysis_date=${currentNgsAvailable.analysis_date}&product_name=${currentNgsAvailable.product_name}&flag=1" width="100%" height="100%" frameborder="0"></iframe>
		  </div>
		  ...
		  <div id="tabs-7" style="height:782px;">
			...
			<div id="tabs-8" style="height:782px;">
				<iframe id="produceAndReviewReport" scrolling="auto" width="100%" height="100%" frameborder="0"></iframe>
			</div>
		</div>
