...
<div id="virtuals-2014" class="m _520_a_lifeandjourney_1 hover" data-ui="u-tab|&amp;|current">
    <div class="mt" >
        ...
        <div hidden="hidden" style="float: left; padding-left: 50px; padding-top: 0px;">
        ...
        <script type="text/javascript">
       		...
       		function urlRun(){
   			  ...
   			  if('${currentNgsAvailable.platform}' == "Life"){
   				 objFrm.src = "${pageContext.request.contextPath}/filterSnpIndel/lifeSnpIndelList?subbarcode=${currentNgsAvailable.subbarcode}&platform=${currentNgsAvailable.platform}&analysis_date=${currentNgsAvailable.analysis_date}&product_name=${currentNgsAvailable.product_name}";
   		     	 ...
   		     	 objFrm.src = "${pageContext.request.contextPath}/filterSnpIndel/illuminaSnpIndelList?subbarcode=${currentNgsAvailable.subbarcode}&platform=${currentNgsAvailable.platform}&analysis_date=${currentNgsAvailable.analysis_date}&product_name=${currentNgsAvailable.product_name}&flag=1";
   			  }
        	...
        	function urlRun1(){
   			  var objFrm = document.getElementById('cnv');
   				if('${currentNgsAvailable.platform}' == "Life"){
   					...
   					objFrm.src = "${pageContext.request.contextPath}/filterCnv/illuminaCnvlList?subbarcode=${currentNgsAvailable.subbarcode}&platform=${currentNgsAvailable.platform}&analysis_date=${currentNgsAvailable.analysis_date}&product_name=${currentNgsAvailable.product_name}&flag=1";
   				}
   		     	 objFrm.style.display = "block";
    		}
        	function urlRun2(){
   			  ...
   			  if('${currentNgsAvailable.platform}' == "Life"){
   				...
   				objFrm.src = "${pageContext.request.contextPath}/filterFusion/illuminaFusionList?subbarcode=${currentNgsAvailable.subbarcode}&platform=${currentNgsAvailable.platform}&analysis_date=${currentNgsAvailable.analysis_date}&product_name=${currentNgsAvailable.product_name}&flag=1";
   			  }
   		      	objFrm.style.display = "block";
    		}
        	function urlRun3(){
        	...
        	function urlRun4(){
	   			  ...
	   			  if('${currentNgsAvailable.platform}' == "Illumina"){
	   				objFrm.src = "${pageContext.request.contextPath}/filterCr/illuminaCrList?subbarcode=${currentNgsAvailable.subbarcode}&platform=${currentNgsAvailable.platform}&analysis_date=${currentNgsAvailable.analysis_date}&product_name=${currentNgsAvailable.product_name}&flag=1";
	   			  }
	   		      	objFrm.style.display = "block";
    		}
            function urlRun5(){
