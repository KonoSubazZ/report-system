			...
			success:function(jsonObject){
			    ...
			    if(jsonObject.total==0){
					...
					$.each(jsonObject.dataList,function(i,n){
                        ...
                        htmlString += '<td><a name="mya" href="http://172.20.1.34/index.php/Home/Index/ldtigvs/bam/'+$("#subbarcode").val()+'G.bam/chr/'+n.chr.replace("chr","")+'/start/'+n.pos+'" target="_blank">'+n.pos+'</a></td>';
  ...
  <div class="panel admin-panel" id="alertBox">
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        ...
        <li style="padding-left:3030px;float: left;color: red;font-size: 14px"><span id="message2"></span></li>
      </ul>
