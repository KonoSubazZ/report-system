...
<script type="text/javascript">
	...
	function displayData(pageNo){
		...
		//alert(isPass);
		$.ajax({
			url:"${pageContext.request.contextPath}/filterSnpIndel/getLifeSnpIndelByPage",
			type:"post",
  ...
  <div class="panel admin-panel">
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        ...
        <li style="padding-left:1507px;float: left;color: red;font-size: 14px"><span id="message2"></span></li> 
      </ul>
    </div>
    <script type="text/javascript">
		    $(function(){
			    $.post("${pageContext.request.contextPath}/filterSnpIndel/getLifeGene",
						function(data){
