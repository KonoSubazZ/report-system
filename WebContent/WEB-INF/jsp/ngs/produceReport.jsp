                ...
                <tr>
                        ...
                        <div class="form-group">
                            ...
                            <div class="field">
                                <input type="text" class="input w50" id="primary_cancer" name="primary_cancer"
                                       value="${diseaseClass.disease_class_chinese}" placeholder="请选择原发癌种"
                                       data-validate="required:请选择原发癌种"/>
                                <input type="hidden" id="primary_cancer_id" name="primary_cancer_id"
                                       value="${diseaseClass.class_id}"/>
                                <script type="text/javascript">
                                    $(function () {
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <div class="field">
                                <input type="text" id="chem_cancer" name="chem_cancer" class="input w50"
                                       value="${chem_cancer}" style="cursor: pointer;" placeholder="请选择化疗癌种"
                                       data-validate="required:请选择化疗癌种"/>
                                <script type="text/javascript">
                                    $(function () {
                ...
                <tr>
                    <td>
                        <div class="form-group">
                            ...
                            <div class="field">
                                <input type="text" class="input w50" id="product_name_chinese"
                                       value="${product.product_name_chinese}" placeholder="必选项！请选择检测产品"
                                       data-validate="required:请选择检测产品"/>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <div class="field">
                                <input type="text" id="target_cancer" name="target_cancer" class="input w50"
                                       value="${target_cancer}" style="cursor: pointer;" placeholder="请选择靶向癌种"
                                       data-validate="required:请选择靶向癌种"/>
                                <script type="text/javascript">
                                    $(function () {
                ...
                <tr>
                    <td>
                        <div class="form-group">
                            ...
                            <div class="field">
                                ...
                                <input type="text" class="input w50" value="" id="template_name" name="template_name"
                                       placeholder="请选择报告模板"/>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <div class="field">
                                <input type="text" id="report_date" name="report_date" class="input w50" value=""
                                       style="cursor: pointer;" placeholder="请选择日期"
                                       onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true,autoPickDate:true,skin:'Stwoer2'})"
                                       data-validate="required:请选择日期"/>
                                <div class="tips"></div>
                            </div>
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <div class="field">
                                <input type="text" class="input w50" value="" placeholder="请选择日期"
                                       style="cursor: pointer;"
                                       onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true,autoPickDate:true,skin:'Stwoer2'})"
                                       id="tested_date" name="tested_date" data-validate="required:请选择日期"/>
                                <div class="tips"></div>
                            </div>
                        </div>
                    </td>
                ...
                <tr>
                    <td>
                        <div class="form-group">
                            ...
                            <div class="field">
                                <input type="text" class="input w50" value="" id="checked_by" name="checked_by"
                                       placeholder="盖章版请输入复核人"/>
                                <div class="tips"></div>
                            </div>
                        </div>
                    </td>
                        ...
                        <div class="form-group">
                            ...
                            <div class="field">
                                <input type="text" class="input w50" value="" placeholder="请选择日期"
                                       style="cursor: pointer;"
                                       onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true,autoPickDate:true,skin:'Stwoer2'})"
                                       id="checked_date" name="checked_date" data-validate="required:请选择日期"/>
                                <div class="tips"></div>
                            </div>
                        </div>
                    </td>
                ...
                <tr class="pic" hidden="true">
                    <td colspan="2">
                        ...
                        <div class="field" style="float:left;margin-left: 7px;width: 109px" id="preview3">
                            <button type="button" class="button bg-main icon-image"
                                    onclick="$('#previewImg3').click();"> 插入图片
                            </button>
                            <img id="imghead3" onclick="$('#previewImg3').click();">
                        </div>
                        <input type="file" accept="image/jpeg,image/png"
                               onchange="previewImage(this,'preview3','previewImg3','imghead3','tumorpuritypictureone')"
                               style="display: none;" id="previewImg3">
                        ...
                        <div class="field" style="float:left;margin-left: 15px;width: 109px" id="preview4">
                            <button type="button" class="button bg-main icon-image"
                                    onclick="$('#previewImg4').click();"> 插入图片
                            </button>
                            <img id="imghead4" onclick="$('#previewImg4').click();">
                        </div>
                        <input type="file" accept="image/jpeg,image/png"
                               onchange="previewImage(this,'preview4','previewImg4','imghead4','tumorpuritypicturetwo')"
                               style="display: none;" id="previewImg4">
                        ...
                        <div class="field" style="float:left;margin-left: 8px;width: 109px" id="preview5">
                            <button type="button" class="button bg-main icon-image"
                                    onclick="$('#previewImg5').click();"> 插入图片
                            </button>
                            <img id="imghead5" onclick="$('#previewImg5').click();">
                        </div>
                        <input type="file" accept="image/jpeg,image/png"
                               onchange="previewImage(this,'preview5','previewImg5','imghead5','tumorpuritypicturethree')"
                               style="display: none;" id="previewImg5">
                ...
                <tr class="pic" hidden="true">
                    <td colspan="2">
                        <div class="form-group" style="margin-right: 50px; margin-top: 12px;">
                            ...
                            <div class="field">
                                <textarea class="input" rows="3" cols="75" style="width: 1145px;"
                                          name="tumorpuritydescription"></textarea>
                                <div class="tips"></div>
                            </div>
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <div class="field">
                                <button id="reportBtn" class="button bg-main icon-check-square-o" type="submit">
                                    产生报告
                                </button>
                            ...
                            <script type="text/javascript">
                                ...
                                function updateStatus() {
                                    ...
                                    let username = "${currentNgsAvailableData.user}";
