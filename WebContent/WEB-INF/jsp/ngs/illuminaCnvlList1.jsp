...
<script type="text/javascript">
	...
	function displayData(pageNo){
		...
		//alert(isPass);
		$.ajax({
			url:"${pageContext.request.contextPath}/filterCnv/getIlluminaCnvByPage",
			type:"post",
			...
			success:function(jsonObject){
			    ...
			    if(jsonObject.total==0){
					...
					$.each(jsonObject.dataList,function(i,n){
                        ...
                        htmlString += '<td><a name="mya" href="http://192.168.1.101:8086/index.php/Home/Index/ldtigvs/bam/'+$("#subbarcode").val()+'T.bam/chr/'+n.chr.replace("chr","")+'/start/'+n.start+'" target="_blank">'+n.start+'</a></td>';
...
<form method="post" action="" id="listform">
  <div class="panel admin-panel" style="width:1680px">
    ...
    <script type="text/javascript">
		    $(function(){
			    $.post("${pageContext.request.contextPath}/filterCnv/getIlluminaCnvGene",
						function(data){
