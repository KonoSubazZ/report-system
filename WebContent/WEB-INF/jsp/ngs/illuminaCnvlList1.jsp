			...
			success:function(jsonObject){
			    ...
			    if(jsonObject.total==0){
					...
					$.each(jsonObject.dataList,function(i,n){
                        ...
                        htmlString += '<td><a name="mya" href="http://172.20.1.34/index.php/Home/Index/ldtigvs/bam/'+$("#subbarcode").val()+'T.bam/chr/'+n.chr.replace("chr","")+'/start/'+n.start+'" target="_blank">'+n.start+'</a></td>';
