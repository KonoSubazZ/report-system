			...
			success:function(jsonObject){
			    ...
			    if(jsonObject.total==0){
					...
					$.each(jsonObject.dataList,function(i,n){
                        ...
                        htmlString += '<td><a name="mya" href="http://127.0.0.1:8086/index.php/Home/Index/ldtigvs/bam/'+$("#subbarcode").val()+'T.bam/chr/'+n.chr.replace("chr","")+'/start/'+n.start+'" target="_blank">'+n.start+'</a></td>';
