...
<script type="text/javascript">
	...
	function displayData(pageNo){
		...
		//alert(isPass);
		$.ajax({
			url:"${pageContext.request.contextPath}/filterFusion/getLifeFusionByPage",
			type:"post",
			...
			success:function(jsonObject){
			    ...
			    if(jsonObject.total==0){
					...
					$.each(jsonObject.dataList,function(i,n){
						...
						htmlString += '<td>'+n.fusion_id+'</td>';
						htmlString += '<td>'+n.fusion_type+'</td>';
						htmlString += '<td>'+n.fusion_left_position+'</td>';
						htmlString += '<td>'+n.fusion_right_position+'</td>';
						htmlString += '<td>'+n.fusion_readcount+'</td>';
						htmlString += '<td>'+n.filter+'</td>';
						htmlString += '<td>'+n.ndf+'</td>';
  ...
  <div class="panel admin-panel" style="width:1680px">
    ...
    <table class="table table-hover text-center">
      <tr>
        ...
        <th>fusion_id</th>
        <th>fusion_type</th>
        <th>fusion_left_position</th>
        <th>fusion_right_position</th>
        <th>fusion_readcount</th>
        <th>filter</th>
        <th>ndf</th>
        <th>gene1</th>
        <th>gene2</th>
