...
<div class="panel admin-panel" style="background-color: #FFF;height: 100vh;">
    ...
    <div class="body-content" style="margin-left:100px;font-size:16px;">
        ...
        <div class="layui-row" style="padding:12px 0;">
            <div class="layui-col-xs5" style="display: flex;">
                <div style="width:100px">二次审核人</div>
                <div>刘嗣凡</div>
            </div>
            <div class="layui-col-xs5" style="display: flex;">
                <div style="width:100px" >二次审核日期</div>
                <div id="second-date"></div>
            </div>
        </div>
        <div class="layui-row" style="padding:12px 0;">
            <div class="layui-col-xs5" style="display: flex;">
                <div style="width:100px">三次审核人</div>
                <div>王建丽</div>
            </div>
            <div class="layui-col-xs5" style="display: flex;">
                <div style="width:100px" >三次审核日期</div>
                <div id="third-date"></div>
            </div>
        </div>
        <div class="layui-row" style="padding:12px 0;">
...
<script>
    ...
    let report_id = "${analysisReport.report_id}";
    let second = localStorage.getItem(report_id + "second-date");
    $("#second-date").text(second);
    // 审核报告 通过、未通过
