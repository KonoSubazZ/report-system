			    ...
			    if(jsonObject.total==0){
					...
					$.each(jsonObject.dataList,function(i,n){
                        ...
                        if (n.fusion_quality.indexOf("RNA") != -1) {
                            htmlString += '<td><a name="mya" href="http://10.33.202.234:8086/index.php/Home/Index/ldtigvs1/bam/'+$("#subbarcode").val()+'R.bam/chr/'+n.chromosome1.replace("chr","")+'/start/'+n.softclip1+'/chr1/'+n.chromosome2.replace("chr","")+'/start1/'+n.softclip2+'" target="_blank">'+n.softclip1+'</a></td>';
                            ...
                            htmlString += '<td><a name="mya" href="http://10.33.202.234:8086/index.php/Home/Index/ldtigvs1/bam/'+$("#subbarcode").val()+'T.bam/chr/'+n.chromosome1.replace("chr","")+'/start/'+n.softclip1+'/chr1/'+n.chromosome2.replace("chr","")+'/start1/'+n.softclip2+'" target="_blank">'+n.softclip1+'</a></td>';
                        ...
                        if (n.fusion_quality.indexOf("RNA") != -1) {
                            htmlString += '<td><a name="mya" href="http://10.33.202.234:8086/index.php/Home/Index/ldtigvs1/bam/'+$("#subbarcode").val()+'R.bam/chr/'+n.chromosome1.replace("chr","")+'/start/'+n.softclip1+'/chr1/'+n.chromosome2.replace("chr","")+'/start1/'+n.softclip2+'" target="_blank">'+n.softclip2+'</a></td>';
                            ...
                            htmlString += '<td><a name="mya" href="http://10.33.202.234:8086/index.php/Home/Index/ldtigvs1/bam/'+$("#subbarcode").val()+'T.bam/chr/'+n.chromosome1.replace("chr","")+'/start/'+n.softclip1+'/chr1/'+n.chromosome2.replace("chr","")+'/start1/'+n.softclip2+'" target="_blank">'+n.softclip2+'</a></td>';
