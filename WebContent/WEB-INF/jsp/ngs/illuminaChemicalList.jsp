...
<script type="text/javascript">
	...
	function displayData(pageNo){
		...
		//alert(isPass);
		$.ajax({
			url:"${pageContext.request.contextPath}/filteChemical/getIlluminaChemicalByPage",
			type:"post",
			...
			success:function(jsonObject){
			    ...
			    if(jsonObject.total==0){
					...
					$.each(jsonObject.dataList,function(i,n){
						...
						htmlString += '<td>'+n.rs_id+'</td>';
						htmlString += '<td>'+n.depth+'</td>';
						htmlString += '<td>'+n.dp4+'</td>';
	...
	function updateFiltered(record_id,id){
		...
		$.ajax({
			url:"${pageContext.request.contextPath}/filteChemical/updateFiltered",
			type:"POST",
