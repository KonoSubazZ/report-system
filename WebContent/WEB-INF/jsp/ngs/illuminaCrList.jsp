...
<head>
    ...
    <script type="text/javascript">
        ...
        function getClinicalSignificanceHtml(n) {
            var clinical = "";
            for (var i = 0; i < crClinicalData.length; i++) {
            ...
            if (bgColor) {
                return '<span style="background-color:'+bgColor+';color:#fff;padding:3px 8px;border-radius:4px;font-size:12px;">'+clinical+'</span>';
            }
                ...
                success:function(jsonObject){
                    ...
                    if(jsonObject.total==0){
                        ...
                        $.each(jsonObject.dataList,function(i,n){
                            ...
                            htmlString += '<td>'+(n.loaded_date == null? "" : n.loaded_date)+'</td>';
                            htmlString += '<td>'+(n.record_id == null? "" : n.record_id)+'</td>';
                            htmlString += '</tr>';
                        });
    ...
    <div class="panel admin-panel" id="alertBox">
        <div class="padding border-bottom">
            <ul class="search" style="padding-left:10px;">
                ...
                <li style="padding-left:3130px;float: left;color: red;font-size: 14px"><span id="message2"></span></li>
            </ul>
        </div>
        <table class="table table-hover text-center">
            <tr>
                ...
                <th>pHGVS</th>
                <th>Zygosity</th>
                <th>Clinical_significance</th> <!-- 带颜色 -->
                <th>ExonicFunc</th>
