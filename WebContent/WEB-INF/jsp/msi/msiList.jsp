...
<script type="text/javascript">
	...
	function displayData(pageNo){
		var pageSize=10;
		if($("#barcode").val() == "" && $("#tested_date").val() == ""){
			$("#message").text("请选择筛选条件");
		}else{
			$("#message").text("");
			$.ajax({
				url:"${pageContext.request.contextPath}/MsiReportVw/getMsiReportByPage",
				type:"post",
  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-blue icon-plus-square-o" href="${pageContext.request.contextPath}/MsiReportVw/addMsiReport"> 添加报告</a>&nbsp;&nbsp;&nbsp;&nbsp;</li>
        <li>患者 ID:</li>
        <li>
          <input type="text" placeholder="请输入搜索关键字" id="barcode" name="barcode" class="input" style="width:250px; line-height:17px;display:inline-block" />
          <script type="text/javascript">
          $(function(){
        	  $.post("${pageContext.request.contextPath}/MsiReportVw/getBarcodeListByVw", function(data){
        			$('#barcode').autocomplete(data, {
        				max : 12, //列表里的条目数
        ...
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 检测时间:</li>
        <li>
          <input type="text" placeholder="选择日期" id="tested_date" name="tested_date" class="input" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true,skin:'twoer'})" style="width:203px; line-height:17px;display:inline-block;cursor: pointer;" />
        </li>
        <li>
        	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
