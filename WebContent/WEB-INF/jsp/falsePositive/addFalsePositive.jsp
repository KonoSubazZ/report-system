...
<div class="panel admin-panel">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>添加假阳</strong></div>
	    ...
	    <tr>
	    	<td>
		      <div class="form-group">
		        ...
		        <div class="field">
		          <input type="text" class="input w50" value="" name="platform" id="platform"  data-validate="required:请输入platform"/>
		          <div class="tips"></div>
	    	...
	    	<td>
	    	  <div class="form-group" style="margin-left: 0px;">
		        ...
		        <div class="field">
		          <input type="text" class="input w50" value="" name="gene" id="gene" data-validate="required:请输入gene" />
		          <div class="tips"></div>
		          <span style="color:#FF0000; font-size:25px;  margin-left:15px">*</span>
		        </div>
		      </div>
	     ...
	     <tr>
	    	<td>
		      <div class="form-group">
		        ...
		        <div class="field">
		          <input type="text" class="input w50" value="" name="chrom" id="chrom" />
		          <div class="tips"></div>
		        </div>
		      </div>
		     </td>
	    	<td>
	    	  <div class="form-group" style="margin-left: 0px;">
		        ...
		        <div class="field">
		          <input type="text" class="input w50" value="" name="start" id="start" />
		          <div class="tips"></div>
		        </div>
		      </div>
		     </td>
	     ...
	     <tr>
	    	<td>
		      <div class="form-group">
		        ...
		        <div class="field">
		          <input type="text" class="input w50" value="" name="end" id="end" />
		          <div class="tips"></div>
		        </div>
		      </div>
		     </td>
	    	<td>
	    	  <div class="form-group" style="margin-left: 0px;">
		        ...
		        <div class="field">
		          <input type="text" class="input w50" value="" name="aachange" id="aachange" data-validate="required:请输入aachange" />
		          <div class="tips"></div>
		          <span style="color:#FF0000; font-size:25px;  margin-left:15px">*</span>
		        </div>
		      </div>
	     ...
	     <tr>
	    	<td>
		      <div class="form-group">
		        ...
		        <div class="field">
		          <input type="text" class="input w50" value="" name="matching_table" id="matching_table" />
		          <div class="tips"></div>
		        </div>
		      </div>
		     </td>
      				...
      				$("#falsePositiveForm").validate({
	    					...
	    					submitHandler:function(){
	    						$.ajax({   
	    							cache: false,
	    							type: "POST",   
	    							url:"${pageContext.request.contextPath}/falsePositive/saveFalsePositive", //把表单数据发送到ajax.jsp  
