                ...
                <tr>
                    <td>
                        <div class="form-group">
                            ...
                            <div class="field">
                                <input type="text" class="input w50" value="" name="subbarcode" id="subbarcode"
                                       onchange="getSampleFileBySubbarcode()"
                                       data-validate="required:请正确填写样本 ID"/>
                                <div class="tips"></div>
                                <script type="text/javascript">
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <div class="field">
                                <button id="sample_lims" style="width: 130px;" class="button bg-main icon-search-plus"
                                        type="button"> 从LIMS抓取
                                </button>
                                <script type="text/javascript">
                                    $(function () {
                ...
                <tr>
                    <td>
                        <div class="form-group" style="margin-right: 50px">
                            ...
                            <div class="field">
                                <input type="text" class="input w50" id="person_name" name="person_name" value=""
                                       disabled="disabled"/>
                                <div class="tips"></div>
                            </div>
                        </div>
                ...
                <tr>
                    <td>
                        <div class="form-group" style="margin-right: 50px">
                            ...
                            <div class="field">
                                <input type="text" class="input w50" id="disease_type" disabled="disabled"
                                       id="disease_type" name="disease_type"/>
                                <div class="tips"></div>
                            </div>
                        </div>
                    </td>
                ...
                <tr>
                    <td>
                        <div class="form-group" style="margin-right: 50px">
                            ...
                            <div class="field">
                                <input type="text" class="input w50" disabled="disabled" id="emailaddress"
                                       name="emailaddress"/>
                                <div class="tips"></div>
                            </div>
                        </div>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <div class="field">
                                <input type="text" class="input w50" value="" disabled="disabled" id="tested_date"
                                       name="tested_date"/>
                                <script type="text/javascript">
                                    $(function () {
                                        getTime("tested_date");
                ...
                <tr>
                    <td>
                        <div class="form-group">
                            ...
                            <div class="field">
                                <input type="text" class="input w50" value="${user.user_account}" disabled="disabled"
                                       id="tested_by" name="tested_by"/>
                                <div class="tips"></div>
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                            ...
                            <div class="field">
                                ...
                                <button class="button bg-main icon-file-o" onclick="javascript: window.history.back();"
                                        style="width: 135px" type="button"> 返回列表
                                </button>
                            </div>
                            <script type="text/javascript">
                                ...
                                function getReport() {
                                    return $.ajax({
                                        url: "${pageContext.request.contextPath}/offlineReport/getReport",
                                        type: "GET",
                                        data: {subbarcode: $("#subbarcode").val()},
                                        dataType: "json"
                                    });
