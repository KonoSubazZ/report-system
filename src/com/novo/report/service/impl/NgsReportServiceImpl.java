        ...
        if (drugCount != 0) {
            ...
            for (Map map : list) {
                ...
                if (!CollectionUtils.isEmpty(drugList)) {
                    ...
                    if (ori_variant.indexOf("Amplification") < 0 && ori_variant.indexOf("Loss") < 0 && !".".equals(mutFreq) && mutFreq.indexOf("H") < 0 && mutFreq.indexOf("合") < 0) {
                        mutFreq += "%";
                    }
...
//			filenameEncoder = filenameEncoder.replace("%2B", "+");
    ...
    public String translateMedicationDescTitle(String str) {
        switch (str) {
            ...
            case "信号通路说明:":
                return "Description of signaling pathway: ";
            case "位点说明:":
                return "Variant description: ";
            case "NCCN指南:":
                return "Description of NCCN Guidelines: ";
            case "预后和诊断说明:":
                return "Description of prognostic diagnosis: ";
            case "耐药说明:":
                return "Description of drug resistance: ";
            case "用药说明:":
                return "Related biological and medical information: ";
            default:
                return str;
        }
    }
