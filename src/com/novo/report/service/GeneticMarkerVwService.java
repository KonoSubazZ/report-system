...
public interface GeneticMarkerVwService {
	...
	public List<Map> saveDrugRecord(List<Map> drugList, String userAccount, String gene, String ori_variant, Integer disease_id,Integer lang);
	
	public void updateVarDrugNote(String var_drug_desc, String userAccount, String gene, String ori_variant, Integer disease_id,Integer lang);
	
	public Map deleteDrugAndAddUnknownVar(String userAccount, String gene, String variant, String ori_variant, Integer disease_id, String resultType, Integer lang);
	...
	public List<Map> saveClinicalRecord(List<Map> clinicalList, String userAccount, String gene, String ori_variant, Integer disease_id,Integer lang);
