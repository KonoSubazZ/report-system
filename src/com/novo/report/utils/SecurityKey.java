...
public class SecurityKey {    
     ...
     * 默认构造方法，使用默认密钥  
     */    
    public SecurityKey() throws Exception {    
        this(strDefaultKey);    
    }    
    /**  
     * 指定密钥构造方法  
     ...
     * @throws Exception  
     */    
    public SecurityKey(String strKey) throws Exception {    
    ...
    public static void main(String[] args) {    
        try {    
            String test1 = "EGFR MET";    
            SecurityKey des1 = new SecurityKey();// 使用默认密钥    
            ...
            String test2 = "L858R位于EGFR蛋白的蛋白激酶结构域[UniProt.org]，L858R导致激酶活性增加，促进肿瘤形成[PMID: 16187797]。";    
            SecurityKey des2 = new SecurityKey("leeme32nz");// 自定义密钥    
