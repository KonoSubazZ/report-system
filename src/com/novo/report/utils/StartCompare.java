...
shorttext.substring(0, j));
   ...
   */
  public String diff_prettyHtml2(LinkedList<Diff> diffs) {
    ...
    for (Diff aDiff : diffs) {
      ...
      case INSERT:
        html.append("<u style=\"color:green;\"").append("\">").append(text).append("</u>");
        break;
      case DELETE:
        html.append("<s style=\"color:red;\"").append("\">").append(text).append("</s>");
        break;
      case EQUAL:
        html.append(text);
        break;
  ...
  //标记版
  public  String getHtmlDiffString2(String text1,String text2){
      return diff_prettyHtml2(diff_main(text1,text2)); 
  }
  //终版
