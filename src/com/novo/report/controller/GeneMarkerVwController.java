...
//                        List<String> poleList = Arrays.asList("Y458H", "Y458C", "Y458N", "P286R", "V411L", "S297F",
//                                "A456P", "S459F", "M444K", "L424I", "P286H",
...
//                                "A428T", "F367C", "P436S", "R665W", "E491K");
            ...
            if (isMelanomaPanel && diseaseService.isMelanoma(diseaseId)) {
                ...
                model.addAttribute("melanomaList1", melanomaList);
            }
            model.addAttribute("isMelanomaFlag", isMelanomaFlag);
