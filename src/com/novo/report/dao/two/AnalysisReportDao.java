...
//	List<Map> getNccnDrugs(@Param("DrugID")Integer DrugID, @Param("list") List<Integer> diseaseIdList,@Param("lang") Integer lang);
    ...
    String getMDM2imgBase64Str(@Param("subbarcode") String subbarcode, @Param("analysis_date") String analysis_date, @Param("product_name") String product_name);
    ...
    Map getMDM2DataInfo(@Param("subbarcode") String subbarcode, @Param("analysis_date") String analysis_date, @Param("product_name") String product_name);
