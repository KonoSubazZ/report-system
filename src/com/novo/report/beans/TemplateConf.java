...
public class TemplateConf {
  ...
  private Boolean testResultSummary;
  private Boolean importantTargetedGeneSummary;
  private Boolean cancerRiskTip;
  ...
  private Boolean iymphomaTyping;
  private Boolean iymphomaPrognosis;
  private Boolean brainGlioma;
  private Boolean midlineCancer;
  private Boolean kidneyCancer;
  private Boolean thyroidCancerPrognosis;
  private Boolean variantList;
  private Boolean somaticDrugTip;
  private Boolean crDrugTip;
  private Boolean somaticMutationTip;
  private Boolean crMutationTip;
  private Boolean somaticMutationDrTip;
  private Boolean crMutationDrTip;
  private Boolean approvedTargetedDrugFdaNmpa;
  private Boolean endocrineTherapy;
  private Boolean tmb;
  private Boolean msi;
  private Boolean mmr;
  private Boolean immunityPN;
  private Boolean hpd;
  private Boolean hlaLon;
  private Boolean hlaLon1;
  ...
  private Boolean variantMutationAnal;
  ...
  private Boolean immunityPNAnal;
  private Boolean hpdAnal;
  private Boolean hlaLohAnal;
  ...
  private Boolean brainGliomaGene;
  private Boolean midlineCancerSignificance;
  private Boolean rccFeatures;
  private Boolean salivaryGlandTumorGene;
  private Boolean endometrialPrognosis;
  private Boolean hrr45Brca45HrdGenebgIntro;
  private Boolean hrr45Brca45GeneIntro;
  private Boolean hrr45Brca45HrdPeopleFeat;
  private Boolean geneInstabilityIntroHrd;
  private Boolean hrdAndTumorTherapy;
  private Boolean commonDrugGeneList;
  private Boolean geneIntro;
  private Boolean cancerBgIntro;
  private Boolean cancerImprotantGene;
  private Boolean testCancerGenePanel;
  private Boolean cancerGenePathogenicity;
  private Boolean methodLimit;
  private Boolean testMethod;
  private Boolean geneticInterpretation;
  private Boolean variantInterpretationStatement;
  private Boolean variantTestSummary;
  private Boolean reference;
  private Boolean screeningMethodsExcludingGenetic;
  private Boolean gliomaMarkerSignificance;
  private Boolean gliomaGeneticRiskGene;
  private Boolean faq;
  ...
  public Boolean getHpd() {
    return hpd;
  }

  public void setHpd(Boolean hpd) {
    this.hpd = hpd;
  }
  ...
  public void setWes(Boolean wes) {
    this.wes = wes;
  }
