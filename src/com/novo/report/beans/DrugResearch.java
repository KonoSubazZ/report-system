...
public class DrugResearch implements Comparable<DrugResearch> {
	...
	public String toString() {
		return "DrugResearch [drug_name_chinese=" + drug_name_chinese + ", disease_name_chinese=" + disease_name_chinese
				+ ", annotation_chinese=" + annotation_chinese + ", evidence_phase_chinese=" + evidence_phase_chinese
				+ "]";
	}
